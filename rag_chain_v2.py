...
def create_rag_chain_v2(hybrid_retriever):
    ...
    bot_persona_cot = (
        ...
        "\n\n"
        "REGRA IMPORTANTE: Você DEVE incluir informações de TODAS as empresas presentes no contexto. "
        "Não omita nenhuma empresa. Se houver dados de 3 empresas, sua resposta deve cobrir as 3.\n\n"
        "Instruções de raciocínio(chain of thought): \n"
        "Antes de responder, siga estes passos internamente:\n"
        ...
        "Primeiro escreva seu raciocínio entre as tags <pensamento> e </pensamento>.\n"
        "Depois escreva a resposta final entre as tags <resposta> e </resposta>.\n"
        "\n"
        "Exemplo:\n"
        "<pensamento>\n"
        "Analisando os trechos... encontrei dados de X e Y...\n"
        "</pensamento>\n"
        "<resposta>\n"
        "A resposta final aqui, em tópicos quando possível.\n"
        "</resposta>\n"
        "\n"
